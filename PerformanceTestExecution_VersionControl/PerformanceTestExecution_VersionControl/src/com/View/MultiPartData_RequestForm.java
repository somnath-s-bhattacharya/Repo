...
public class MultiPartData_RequestForm extends JFrame {

	private JPanel contentPane;
	
	public static String HN1=null;
	public static String HV1=null;
	public static String HN2=null;
	public static String HV2=null;
	public static String HN3=null;
	public static String HV3=null;
	public static String HN4=null;
	public static String HV4=null;
	public static String HN5=null;
	public static String HV5=null;
	public static String HN6=null;
	public static String HV6=null;
	public static String HN7=null;
	public static String HV7=null;
	public static String HN8=null;
	public static String HV8=null;
	public static String HN9=null;
	public static String HV9=null;
	public static String HN10=null;
	public static String HV10=null;

	/**
	 * Launch the application.
	 */
	
	public static void MultiPartData_RequestForm() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MultiPartData_RequestForm frame = new MultiPartData_RequestForm();
	...
	public MultiPartData_RequestForm() {
		...
		JLabel lblHeaderName = new JLabel("Field Name");
		lblHeaderName.setFont(new Font("Calibri", Font.BOLD, 14));
		lblHeaderName.setBounds(97, 26, 88, 14);
		contentPane.add(lblHeaderName);
		
		JLabel lblHeaderValue = new JLabel("Field Value");
		lblHeaderValue.setFont(new Font("Calibri", Font.BOLD, 14));
		lblHeaderValue.setBounds(357, 26, 88, 14);
		...
		JButton btnSaveValues = new JButton("Done");
		...
		btnSaveValues.setBackground(SystemColor.activeCaption);
		btnSaveValues.setFont(new Font("Calibri", Font.BOLD, 14));
		btnSaveValues.setBounds(357, 399, 128, 23);
		contentPane.add(btnSaveValues);
		
		JButton addAttachments = new JButton("Add Attachment(s)");
		addAttachments.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Attachments frmAttachments = new Attachments();
				frmAttachments.setVisible(true);
			}
		});
		addAttachments.setBounds(319, 364, 185, 29);
		contentPane.add(addAttachments);
	}
}

...
public class GetMember {
	...
	public static void main(String[] args) throws IOException, JSONException {
        ...
        BufferedReader br1 = new BufferedReader(new FileReader("Z-Resources/MDS/MemberRegistration/Payload/InputJSON.txt"));
	    try {   
...
//	    HttpPost post = new HttpPost("http://rnq1mb301.copart.com:10501/members-ws/members/");
	    HttpGet get = new HttpGet("http://rnq1mb301.copart.com:10501/members-ws/members/700020010");
...
//	    post.setHeader("Host","rnq1mb301.copart.com:10501");	    
//	    post.setHeader("Connection","Keep-Alive");
//	    post.setHeader("memberId","700020010)");
		    ...
		    if (httpresponse.getStatusLine().getStatusCode() != 404)
		    {
		    	...
		    	{	
		    		if (httpresponse.getStatusLine().getStatusCode() != 500)
		    		{
				        ...
				        try
				        {
				        	String responseXML ="Z-Resources/MDS/MemberRegistration/Response/ResponseXML.xml";

package com.AssignmentCustomeMakeModelTrim;
...
public class AssignmentCreationWithMakeModelTrim_Execution {
	...
	public static void main(String[] args) throws IOException, JSONException {
        ...
        BufferedReader br1 = new BufferedReader(new FileReader("Z-Resources/AssignmentCreationWithMakeModelTrim_Execution/Payload/InputJSON.txt"));
	    try {   
		    ...
		    if (httpresponse.getStatusLine().getStatusCode() != 404)
		    {
		    	...
		    	{	
		    		if (httpresponse.getStatusLine().getStatusCode() != 500)
		    		{
				        ...
				        try
				        {
				        	String responseXML ="Z-Resources/AssignmentCreationWithMakeModelTrim_Execution/Response/ResponseXML.xml";
